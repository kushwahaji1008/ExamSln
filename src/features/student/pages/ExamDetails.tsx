    ...
    <div className="max-w-4xl mx-auto font-sans py-8">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="bg-card border border-slate-200 rounded-[2rem] p-8 shadow-sm">
          ...
          <div className="bg-rose-50 border border-rose-200 rounded-[2rem] p-8">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="bg-card rounded-xl p-3 text-center border border-rose-100 shadow-sm">
        ...
        <div className="space-y-6">
          <div className="bg-card border border-slate-200 rounded-[2rem] p-6 shadow-sm sticky top-24">
            ...
            <label className="flex items-start gap-3 mb-6 cursor-pointer group">
              <div className="relative flex items-start">
                ...
                <div className="w-5 h-5 border-2 border-slate-300 rounded bg-card peer-checked:bg-indigo-600 peer-checked:border-indigo-600 transition flex items-center justify-center">
            ...
            <button 
              onClick={handleStart}
              disabled={!agreed}
              className="w-full py-4 rounded-xl bg-indigo-600 text-primary-foreground font-bold text-sm hover:bg-indigo-500 transition shadow-lg shadow-indigo-500/30 disabled:opacity-50 disabled:pointer-events-none"
            >
              Start Exam Now
            </button>
          </div>
