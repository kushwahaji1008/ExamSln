    ...
    <div className="mx-auto max-w-7xl space-y-8 p-4 sm:p-6 lg:p-8 font-sans text-slate-100">
      ...
      <div className="relative max-w-md">
        ...
        <input 
          ...
          className="w-full rounded-xl border border-slate-800 bg-slate-900/80 pl-12 pr-4 py-3 text-sm text-primary-foreground placeholder:text-slate-500 outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500"
        />
      </div>

      <div className="rounded-3xl border border-border/10 bg-slate-900/80 backdrop-blur-xl overflow-hidden">
        <div className="divide-y divide-border/5">
          {resources.map((res) => (
            <div key={res.id} className="flex items-center justify-between p-4 sm:p-6 hover:bg-slate-800/50 transition">
              <div className="flex items-center gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-slate-800 text-slate-400 border border-border/5">
              ...
              <button className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-800 text-slate-300 hover:bg-sky-500 hover:text-primary-foreground transition">
