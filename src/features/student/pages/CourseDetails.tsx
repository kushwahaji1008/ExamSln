...
export default function CourseDetails() {
  return (
    <div className="space-y-6 max-w-7xl mx-auto font-sans pb-12">
      ...
      {/* Course Header */}
      <div className="flex flex-col md:flex-row justify-between items-start gap-4 bg-card border border-slate-200 rounded-[2rem] p-6 shadow-sm">
        <div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="w-full aspect-video bg-slate-900 rounded-[2rem] flex flex-col items-center justify-center text-primary-foreground shadow-lg overflow-hidden relative">
            <PlayCircle className="w-16 h-16 text-primary-foreground/50 mb-4 cursor-pointer hover:text-primary-foreground hover:scale-110 transition-all" />
          ...
          <div className="bg-card border border-slate-200 rounded-[2rem] p-6 shadow-sm space-y-4">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-card border border-slate-200 rounded-[2rem] shadow-sm overflow-hidden">
            ...
            {/* Course Exam Link */}
            <div className="bg-indigo-600 p-5 mt-2 text-primary-foreground">
              ...
              <Link to="/student/exams/e123" className="block text-center w-full bg-card text-indigo-600 font-bold py-2 rounded-xl text-sm hover:bg-indigo-50 transition">
                View Exam Details
              </Link>
            </div>
          </div>
