  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 font-sans text-slate-100">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-6">
          <div className="rounded-3xl bg-slate-900/80 border border-sky-500/30 p-8 shadow-xl shadow-sky-500/5 backdrop-blur-xl relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-6">
              ...
              <div className="text-3xl font-extrabold text-primary-foreground">$49<span className="text-sm text-slate-500 font-medium">/mo</span></div>
            </div>
            <div className="flex gap-4">
              <button className="bg-sky-500 hover:bg-sky-400 text-primary-foreground px-5 py-2.5 rounded-xl text-sm font-semibold transition">Upgrade Plan</button>
              <button className="bg-slate-800 hover:bg-slate-700 text-primary-foreground border border-border/10 px-5 py-2.5 rounded-xl text-sm font-semibold transition">Cancel Subscription</button>
            </div>
          </div>

          {/* Payment Method */}
          <div className="rounded-3xl bg-slate-900/80 border border-border/10 p-8 backdrop-blur-xl">
            <h3 className="text-lg font-bold text-primary-foreground mb-4 border-b border-border/10 pb-4">Payment Method</h3>
            <div className="flex items-center justify-between bg-slate-950/50 border border-border/5 p-4 rounded-2xl">
        ...
        {/* Invoices */}
        <div className="rounded-3xl bg-slate-900/80 border border-border/10 p-8 backdrop-blur-xl h-fit">
          <h3 className="text-lg font-bold text-primary-foreground mb-4 border-b border-border/10 pb-4">Recent Invoices</h3>
