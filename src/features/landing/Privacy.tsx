  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 py-20 px-4">
      <div className="max-w-3xl mx-auto bg-slate-900/80 border border-white/10 p-8 sm:p-12 rounded-3xl backdrop-blur-xl space-y-8">
        <h1 className="text-3xl font-extrabold text-white tracking-tight border-b border-white/10 pb-6">Privacy Policy</h1>
        <div className="space-y-6 text-sm text-slate-400 leading-relaxed">
          <p>Last updated: August 4, 2026</p>
          
          <h2 className="text-xl font-bold text-white mt-8 mb-4">Data Collection & Usage</h2>
          ...
          <h2 className="text-xl font-bold text-white mt-8 mb-4">Proctoring Data</h2>
