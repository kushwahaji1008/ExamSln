    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 py-20 px-4">
      <div className="max-w-4xl mx-auto space-y-16">
        <div className="text-center space-y-4">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight">About ExamSolution</h1>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-slate-900/80 border border-white/10 p-8 rounded-3xl backdrop-blur-xl text-center">
          ...
          <div className="bg-slate-900/80 border border-white/10 p-8 rounded-3xl backdrop-blur-xl text-center">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Insightful</h3>
