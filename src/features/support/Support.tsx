  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8 space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-6">
        <div>
          <h1 className="text-3xl font-extrabold text-white tracking-tight">Support Desk</h1>
          <p className="text-sm text-slate-400 mt-1">Get help with exams, technical issues, or billing.</p>
        </div>
        <button className="inline-flex items-center gap-2 rounded-xl bg-sky-500 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-sky-400">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2 space-y-4">
          <h2 className="text-lg font-bold text-white mb-2">My Tickets</h2>
          
          <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-6 backdrop-blur-xl flex flex-col sm:flex-row justify-between sm:items-center gap-4 hover:border-sky-500/30 transition">
            <div className="flex items-start gap-4">
              <div className="mt-1 bg-amber-500/10 text-amber-400 p-2 rounded-xl"><LifeBuoy className="w-5 h-5" /></div>
              <div>
                <h3 className="text-base font-bold text-white">Webcam not detecting during exam start</h3>
          ...
          <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-6 backdrop-blur-xl flex flex-col sm:flex-row justify-between sm:items-center gap-4 opacity-75 hover:opacity-100 transition">
            <div className="flex items-start gap-4">
              <div className="mt-1 bg-slate-800 text-slate-400 p-2 rounded-xl"><MessageSquare className="w-5 h-5" /></div>
              <div>
                <h3 className="text-base font-bold text-white">How to change my time zone?</h3>
        ...
        <div className="space-y-6">
          <div className="bg-slate-900/80 border border-white/10 rounded-3xl p-6 backdrop-blur-xl">
            <h3 className="text-sm font-bold text-white uppercase tracking-wider mb-4">Quick Help</h3>
